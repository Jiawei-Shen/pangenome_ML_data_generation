...
# ─────────────────────────────────────────────────────────────────────────────
# Provided .idx loader (UPDATED to support latest 30B entries)
#
...
def load_index(idx_path):
    """Loads node IDs from a binary .idx file (latest format: 30B entries)."""
    node_index = {}
    try:
        with open(idx_path, "rb") as f:
            ...
            for i in range(blocks_num):
                ...
                node_index[block_id] = True  # We only care about existence / order
